...
const terminalMessages = {
  en: {
    ...
    catsUsage: 'Usage: cats [activate|deactivate]',
    catsActivated: 'Cats activated.',
    catsDeactivated: 'Cats deactivated.',
    catsAlreadyActive: 'Cats are already active.',
    catsAlreadyInactive: 'Cats are already inactive.',
    catsUnknownAction: (action) => `cats: unknown action '${action}'`,
  ...
  no: {
    ...
    catsUsage: 'Bruk: cats [activate|deactivate]',
    catsActivated: 'Katter aktivert.',
    catsDeactivated: 'Katter deaktivert.',
    catsAlreadyActive: 'Kattene er allerede aktive.',
    catsAlreadyInactive: 'Kattene er allerede deaktiverte.',
    catsUnknownAction: (action) => `cats: ukjent handling '${action}'`,
