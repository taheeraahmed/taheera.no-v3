...
export const projects = {
  fishtracker: 'FishTracker (NINAnor): data and analysis tooling contributions.',
  miljodata: 'Miljodata DataSync: backend improvements and data pipeline reliability.',
  portfolio: 'This portfolio in React: design, localization, and product storytelling.',
  shell: 'A simple shell in C with support for core commands like cd, ls, and pipes.',
}
...
export const aboutMe = {
  ...
  reading: {
    text: `Okei I have to admit, yes I do like reading, but if I do it often?? HMM that variues. I tend to read more in the summer though. I also like to listen to NRK Leseklubben podcast WHILE I read!! this gives me a lot of motivation for finishing my book :D`,
    image: '/lese.jpg',
